...
function Profile() {
    ...
    const addUserData = (e) => {
        if (e.target.name === "img") {
            ...
            setErros({
                ...error,
                comment: e.target.value.length === 0 ? "This Field is Required" : e.target.value.length < 3 ? "Min Length is 3 Char" : null
            })
        }
    ...
    const changeUserData = (e) => {
        if (e.target.name === "name") {
            ...
            setErros({
                ...error,
                spetialization: e.target.value.length === 0 ? "This Field is Required" : null
            })
        }
        ...
        uploadTask.on('state_changed',
            ...
            () => {
                getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
                    getUser.portofolio.push({ "title": userData.title, "caption": userData.caption, "image": downloadURL })
    ...
    const handleButtonComment = () => {
        getUser.feedback.push({ "comment": userData.comment, "rating": userData.rating })
                        ...
                        <div className='d-flex align-items-center'>
                            ...
                            <div className='d-flex '>
                                {getUser.image === "" ?
                                    ...
                                    </img> : <img className='imgprofile' src={getUser.image} alt=''>
                                    </img>}
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-3 col-12 mb-5">
                                    <div className=" flex-column  nav" role="tablist">
                                        ...
                                        <button className="btn btn-outline-dark text-start border-secondary-subtle rounded-0 p-3 text-uppercase" type="button" id="feedback-tab" data-bs-target="#feedback" data-bs-toggle="tab" role="tab" aria-controls="feedback" aria-selected="false" tabIndex="-1">
                                        ...
                                        <button className="btn btn-outline-dark text-start border-secondary-subtle rounded-0 p-3 text-uppercase" type="button" id="cart-tab" data-bs-target="#cart" data-bs-toggle="tab" role="tab" aria-controls="cart" aria-selected="false" tabIndex="-1">
                                            <i className="pe-2 fa fa-cart-shopping"></i>
                                            cart
                                        </button> <button className="btn btn-outline-dark text-start border-secondary-subtle rounded-0 p-3 text-uppercase" type="button" id="wishlist-tab" data-bs-target="#wishlist" data-bs-toggle="tab" role="tab" aria-controls="wishlist" aria-selected="false" tabIndex="-1">
                                ...
                                <div className="col-xl-9 col-12 w-xl-100">
                                    <div className="tab-content" id="myaccountContent">
                                        ...
                                        {/* <!-- Single Tab Content End --> */}
                                        {/* <!-- Single Tab Content Start --> */}
                                        <div className="tab-pane fade" id="feedback" role="tabpanel" aria-labelledby="feedback-tab" tabIndex="0">
                                            <div className="border p-4">
...

                                                {
                                                    getFeedback?.map((feedback, index) => {
                                                        return (
                                                            < >
                                                                <div className='bg-body-secondary rounded-3 d-flex m-2 align-items-center' key={index}>
                                                                    <p className='m-4 w-75'><strong>{feedback.comment}</strong></p>
                                                ...
                                                <form onSubmit={(e) => submitData(e)}>
                                                    <div className="col-12 ">
                                                        <textarea className='border m-2 border-secondary-subtle w-100 p-3 d-block ' placeholder="Left FeedBack" type="text" name='comment' onChange={(e) => addUserData(e)} />
                                                        <p className="text-danger ms-2"> <small>{error.comment}</small> </p>
                                                    </div>
                                                    <div className="mb-3 d-flex">
                                                        <select name="rating" onChange={(e) => addUserData(e)} className="border m-2 border-secondary-subtle w-50 p-3 d-block">
                                                    ...
                                                    <div className="col-12">
                                                        <button className="btn btn-outline-dark text-uppercase p-2 m-2" disabled={error.rating || error.comment || userData.comment === "" || userData.rating==="rating"}
                                                            onClick={() => handleButtonComment()} type='reset'>Comment</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        {/* <!-- Single Tab Content End --> */}
                                        {/* <!-- Single Tab Content Start --> */}
                                        <div className="tab-pane fade" id="cart" role="tabpanel" aria-labelledby="cart-tab" tabIndex="0">
                                            <div className="border p-4">
                                        ...
                                        {/* <!-- Single Tab Content End --> */}
                                        {/* <!-- Single Tab Content Start --> */}
                                        <div className="tab-pane fade" id="wishlist" role="tabpanel" aria-labelledby="wishlist-tab" tabIndex="0">
                                            <div className="border p-4">
                                                ...
                                                <div className="account-details-form">
                                                    ...
                                                    <div >
                                                        <form onSubmit={(e) => submitData(e)} className="row ">
                                                            ...
                                                            <div className="col-12 ">
                                                                <input className='w-100 p-3 m-2  m-2   form-control ' accept="image/*" type="file" name='image' onChange={(e) => changeUserData(e)} />
                                                                <p className="text-danger ms-2"> <small>{error.image}</small> </p>
                                                            </div>
                                                            <div className="mb-3">
